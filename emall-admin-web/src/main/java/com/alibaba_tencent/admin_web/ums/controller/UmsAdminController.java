...
import com.alibaba_tencent.admin_web.ums.vo.UmsAdminLoginParam;
import com.alibaba_tencent.admin_web.ums.vo.UmsAdminParam;
import com.alibaba_tencent.admin_web.utils.JwtTokenUtil;
...
public class UmsAdminController {
    ...
    @Value("${emall.jwt.tokenHeader}")
    private String tokenHeader;
    @Value("${emall.jwt.tokenHead}")
